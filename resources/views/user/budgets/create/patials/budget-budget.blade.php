    ...
    <form action="{{ route('budgets.upsert', ['budget' => $serial]) }}" method="POST" id="budget-form">
        ...
        <section class="grid grid-cols-2 gap-2">
            ...
            <section class="space-y-2">
                ...
                <x-form.input id="date" name="date" type="date" :disabled="!$isOwner" :value="old('date', $data->date ?? '')" class="block w-full"
            ...
            <section class="space-y-2">
                ...
                <x-form.input id="value" name="value" type="number" :value="old('value', $data->value ?? '')" class="block w-full"
                    :placeholder="__('budgets.input-value-placeholder')" :disabled="!$isOwner" autocomplete="new-value" />
            ...
            <section class="space-y-2">
                ...
                <x-form.input id="order_at" name="order_at" type="date" :disabled="!$isOwner" :value="old('order_at', $data->order_at ?? '')" class="block w-full"
            ...
            <section class="space-y-2">
                ...
                <x-form.input id="title" :value="old('title', $data->title ?? '')" :disabled="!$isOwner" name="title" :placeholder="__('budgets.input-title-placeholder')" type="text"
            ...
            <section class="space-y-2">
                ...
                <x-form.input id="place" :value="old('place', $data->place ?? '')" :disabled="!$isOwner" name="place" :placeholder="__('budgets.input-place-placeholder')" type="text"
