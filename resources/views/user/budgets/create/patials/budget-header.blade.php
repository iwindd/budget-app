    ...
    <section class="grid grid-cols-2 gap-2">
        <section class="space-y-2">
            ...
            <x-form.input id="serial" value="{{ $serial }}" disabled name="serial" type="text"
                class="block w-full" autocomplete="new-serial" />
        ...
        <section class="space-y-2">
            ...
            <x-form.input id="value" name="value" type="text" class="block w-full" :placeholder="__('budgets.input-value-placeholder')" autocomplete="new-value" />
