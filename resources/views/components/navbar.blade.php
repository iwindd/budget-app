<nav aria-label="secondary" x-data="{ open: false }"
    ...
    <div class="flex items-center gap-3">
        <x-button type="button" class="md:hidden" variant="secondary" sr-text="Open main menu"
            x-on:click="isSidebarOpen = !isSidebarOpen">
            <x-heroicon-c-bars-3 x-show="!isSidebarOpen" aria-hidden="true" class="w-6 h-6" />
...
{{--         <x-button type="button" class="hidden md:inline-flex" icon-only variant="secondary" sr-text="Toggle dark mode"
        ...
        <x-dropdown position="bottom" width="48">
            <x-slot name="trigger">
                <button
